...
femMeta = femMeta[ which(femMeta$TissueType=='Root'), ]
...
sizeGrWindow(12,9)
pdf(file = "Plots/Root_PlantsampleClustering.pdf", width = 12, height = 9);
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
save(datExpr, file = "Root-01-dataInput.RData")
...
lnames = load(file = "Root-01-dataInput.RData");
...
par(mfrow = c(1,2));
cex1 = 0.9;
pdf(file = "Plots/Root_SoftThresholdvScaleFreeToplogy.pdf", width = 12, height = 9);
...
dev.off()
pdf(file = "Plots/Root_SoftThresholdvsMeanConnectivity.pdf", width = 12, height = 9);
...
save(dissTOM, file = "Root-01-dissTOM.RData")
#=====================================================================================
#
#  Code chunk 5
#
...
sizeGrWindow(12,9)
pdf(file = "Plots/Root_Gene Clustering.pdf", width = 12, height = 9);
...
pdf(file = "Plots/Root_Gene Dendogram with module colors.pdf", width = 12, height = 9);
sizeGrWindow(8,6)
...
# Plot the result
pdf(file = "Plots/Root_ClusterinfofModuleEigengenes.pdf", width = 12, height = 9);
sizeGrWindow(7, 6)
...
sizeGrWindow(12, 9)
pdf(file = "Plots/Root_geneDendro-3.pdf", wi = 9, he = 6)
